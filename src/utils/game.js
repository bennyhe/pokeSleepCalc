...
export function getRandomIV(pokeId, options) {
  const { isFirst243, isFirst244, isFirst245, isFirst488, isFirst380, isFirst381, isFirst150, lockSkillCount } = options
  let ivRes = {
    useFoods: [],
  ...
  } else if ((isFirst488 && pokeId === 488) || (isFirst380 && pokeId === 380) || (isFirst381 && pokeId === 381) || (isFirst150 && pokeId === 150)) {
    ivRes = {
      ...ivRes,
      ...POKE_243_IV,
      ...POKE_488_IV
