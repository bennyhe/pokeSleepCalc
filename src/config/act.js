...
export const LAB_CONFIG = {
  upIdsSmallIds: [4, 5, 6, 7, 8, 9, 25, 26, 37, 38, 54, 55, 58, 59, 79, 80, 134, 135, 136, 155, 156, 157, 158, 159, 160, 172, 179, 180, 181, 194, 195, 199, 255, 258, 311, 312, 403, 404, 405, 702, 909, 910, 912, 913, 921, 922, 923],
  upIdsMidIds: [243, 244, 245],
  upIdsLargeIds: [],
  noLastList: []
}
export const ACT_LIST = [
  ...
  },
  {
    name: '满月日',
    namejp: '満月の日',
    startTime: 1757275200000,
    endTime: 1757361599000,
    notArea: [],
    largeUp: [35, 36, 173],
    smallUp: [4, 5, 6, 7, 8, 9, 25, 26, 37, 38, 54, 55, 58, 59, 79, 80, 134, 135, 136, 155, 156, 157, 158, 159, 160, 172, 179, 180, 181, 194, 195, 199, 255, 258, 311, 312, 403, 404, 405, 702, 909, 910, 912, 913, 921, 922, 923],
    midUp: [243, 244, 245],
    times: 4,
    isActRandom: true
  },
  {
    name: '好眠日',
    namejp: '満月の前後の日',
    startTime: 1757361600000,
    endTime: 1757447999000,
    notArea: [],
    midUp: [35, 36, 173, 243, 244, 245],
    smallUp: [4, 5, 6, 7, 8, 9, 25, 26, 37, 38, 54, 55, 58, 59, 79, 80, 134, 135, 136, 155, 156, 157, 158, 159, 160, 172, 179, 180, 181, 194, 195, 199, 255, 258, 311, 312, 403, 404, 405, 702, 909, 910, 912, 913, 921, 922, 923],
    times: 1.5,
    isActRandom: true
  },
  {
    name: '雷公＆炎帝＆水君研究',
    namejp: 'ライコウ・エンテイ・スイクンリサーチ',
    startTime: 1757448000000,
  ...
  },
  {
    name: '雷公＆炎帝＆水君研究',
    namejp: 'ライコウ・エンテイ・スイクンリサーチ',
    startTime: 1758398400000,
    endTime: 1758484799000,
    notArea: [],
    times: 1.5,
    smallUp: [4, 5, 6, 7, 8, 9, 25, 26, 37, 38, 54, 55, 58, 59, 79, 80, 134, 135, 136, 155, 156, 157, 158, 159, 160, 172, 179, 180, 181, 194, 195, 199, 255, 258, 311, 312, 403, 404, 405, 702, 909, 910, 912, 913, 921, 922, 923],
    midUp: [243, 244, 245],
