...
export const LAB_CONFIG = {
  upIdsSmallIds: [],
  upIdsMidIds: [4, 5, 6, 7, 8, 9, 25, 26, 37, 38, 54, 55, 58, 59, 79, 80, 134, 135, 136, 155, 156, 157, 158, 159, 160, 172, 179, 180, 181, 194, 195, 199, 255, 258, 311, 312, 403, 404, 405, 702, 909, 910, 912, 913, 921, 922, 923],
  upIdsLargeIds: [],
  noLastList: []
}
export const ACT_LIST = [
  ...
  // },
  {
    name: '3屬性週',
    namejp: 'トリプルタイプウィーク',
    startTime: 1756065600000,
    endTime: 1756670399000,
    notArea: [],
    midUp: [4, 5, 6, 7, 8, 9, 25, 26, 37, 38, 54, 55, 58, 59, 79, 80, 134, 135, 136, 155, 156, 157, 158, 159, 160, 172, 179, 180, 181, 194, 195, 199, 255, 258, 311, 312, 403, 404, 405, 702, 909, 910, 912, 913, 921, 922, 923],
    isActRandom: true
  }
]